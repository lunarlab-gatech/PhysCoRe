"""
Segment one camera video with GroundingDINO and SAM 2.
"""
...
if not CHECKPOINT_DIR:
    raise SystemExit(
        "CHECKPOINT_DIR env var not set. Point it at a directory containing "
        "GroundingDINO_SwinT_OGC.py, groundingdino_swint_ogc.pth, sam2.1_hiera_large.pt"
    )
GROUNDING_DINO_CONFIG = f"{CHECKPOINT_DIR}/GroundingDINO_SwinT_OGC.py"
GROUNDING_DINO_CHECKPOINT = f"{CHECKPOINT_DIR}/groundingdino_swint_ogc.pth"
BOX_THRESHOLD = 0.25
TEXT_THRESHOLD = 0.20
...
sam2_checkpoint = f"{CHECKPOINT_DIR}/sam2.1_hiera_large.pt"
